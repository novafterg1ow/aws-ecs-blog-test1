...
docker tag my-blog-app:1.0.0 833822972447.dkr.ecr.ap-northeast-2.amazonaws.com/dev/my-repo:my-blog-app-1.0.0

# 이미지를 ECR로 푸시
docker push 833822972447.dkr.ecr.ap-northeast-2.amazonaws.com/{repo}/{appname}
docker push 833822972447.dkr.ecr.ap-northeast-2.amazonaws.com/dev/my-repo:my-blog-app-1.0.0
